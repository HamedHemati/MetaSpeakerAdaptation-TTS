...
class WaveRNN(nn.Module) :
    def __init__(self, **params):
        ...
        self.feat_dims = self.params["audio_params"]["n_mels"]
        ...
        self.hop_length = self.params["audio_params"]["hop_length"]
        self.sample_rate = self.params["audio_params"]["sample_rate"]
